<div class="grid grid-cols-1 gap-4 sm:grid-cols-2 md:gap-6">
    ...
    >
      ...
      >
        <i class="text-gray-800 dark:text-white/90 text-xl fa-solid fa-book-medical"></i>
      </div>
    ...
    >
      <div
        class="flex items-center justify-center w-12 h-12 bg-gray-100 rounded-xl dark:bg-gray-800"
      >
        <i class="text-gray-800 dark:text-white/90 text-xl fa-solid fa-dna"></i>
      </div>

      <div class="flex items-end justify-between mt-5">
        <div>
          <span class="text-sm text-gray-500 dark:text-gray-400">Analisis</span>
            <h4 class="mt-2 font-bold text-gray-800 text-title-sm dark:text-white/90">
                {{ $clientes->count() }}            
            </h4>
        </div>
