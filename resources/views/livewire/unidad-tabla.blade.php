                    ...
                    <td class="px-4 py-1 text-center whitespace-nowrap text-sm font-medium">
                        <div x-data="{ dropdownOpen: false }" class="inline-block">
                            ...
                            <template x-teleport="body">
                                ...
                                >
                                    <div class="p-1">
                                        <a href="{{ route('tipo_metodo.edit', $value->id) }}" class="flex items-center px-3 py-2 text-sm text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-lg">
