    ...
    <select
        ...
        {{ $attributes->merge([
            'class' => "
                ...
                " . ($messages 
                        ? 'border-red-300 text-error-600' 
                        : 'border-gray-300 text-gray-400 dark:border-gray-700'
                    ) . "
                bg-transparent px-4 py-2.5 pr-11 text-sm
                placeholder:text-gray-400
                focus:ring-3 focus:outline-hidden 
                dark:bg-gray-900
            "
        ]) }}
        {{-- Cambiamos la lógica de color aquí --}}
        :class="isOptionSelected ? 'text-gray-800 dark:text-gray-100' : 'text-gray-400 dark:text-white/30'"
